const functions = [
    ...
    },
    {
        ...
        description: "Create a loan account after all verifications and agreements are complete",
        parameters: {
            type: "object",
            properties: {
                opportunityId: {
                    type: "string",
                    description: "The opportunity ID for loan account creation"
                }
            },
            required: ["opportunityId"]
        }
    ...
    {
        name: "generate_loan_contract",
        description: "Generate a loan contract including Key Fact Statement (KFS) and Agreement for user review and acceptance",
        parameters: {
            type: "object",
            required: ["opportunityId", "creditLimit", "sanctionLimit", "interestRate", "tenure", "processingFee"],
            properties: {
                opportunityId: {
                    type: "string",
                    description: "Unique identifier for the loan opportunity"
                },
                creditLimit: {
                    type: "number",
                    description: "Maximum credit limit for the loan"
                },
                sanctionLimit: {
                    type: "number",
                ...
                processingFee: {
                    type: "number",
                    description: "Processing fee for the loan"
                },
                enhanceLimitFee: {
                    type: "number",
                    description: "Fee for enhancing credit limit (optional)"
                },
                renewalFee: {
                    type: "number",
                    description: "Fee for loan renewal (optional)"
                },
                marginPledgeFee: {
                    type: "number",
                    description: "Fee for margin pledge (optional)"
                }
            }
        }
    },
    {
        name: "check_loan_contract_status",
        description: "Check the status of the loan contract (both KFS and Agreement)",
        parameters: {
            type: "object",
            required: ["opportunityId"],
            properties: {
